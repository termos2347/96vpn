...
def main_keyboard() -> ReplyKeyboardMarkup:
    # Временно убраны кнопки "🛡️ Подключить обход", "💰 Оплатить обход" и "🆓 Прокси"
    kb = [
        [KeyboardButton(text="🚀 Подключить VPN"), KeyboardButton(text="💳 Оплатить VPN")],
        # [KeyboardButton(text="🛡️ Подключить обход"), KeyboardButton(text="💰 Оплатить обход")],
        [KeyboardButton(text="ℹ️ Инфо")],
        # [KeyboardButton(text="🆓 Прокси")],  # временно убрано
    ]
...
# Временно закомментированы функции для обхода DPI (они не используются, пока нет кнопок)
